...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore[] arraySema = new SimpleSemaphore[2];
        ...
        public PlayPingPongThread(String stringToPrint,
        	...
        	this.arraySema[FIRST_SEMA] = semaphoreOne;
        	this.arraySema[SECOND_SEMA] = semaphoreTwo;
        ...
        private void acquire() {
            // TODO fill in here
        	arraySema[FIRST_SEMA].acquireUninterruptibly();
        }
